    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-10 shadow-lg">
        <div className="text-center">
          ...
          <div className="inline-block px-3 py-1 rounded-lg bg-emerald-50 border border-emerald-200 text-xs font-extrabold text-emerald-800 mb-2">
          ...
          <p className="mt-1.5 text-xs sm:text-sm font-medium text-slate-700 max-w-xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-4 sm:p-6">
            <h2 className="text-xs font-bold uppercase tracking-wider text-[#0B2A4A] mb-3 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300 bg-white p-3 text-xs sm:text-sm font-medium text-slate-900 focus:border-[#0B2A4A] focus:outline-none"
                />
              </div>
              ...
              {DOMAIN_OPTIONS.map((d) => (
                <button
                  ...
                  className={`rounded-xl border p-3 text-left text-xs font-bold transition cursor-pointer flex items-center justify-between ${
                    domain === d.id
                      ? 'border-emerald-600 bg-emerald-50 text-emerald-950 hover:bg-emerald-100 ring-2 ring-emerald-600'
          ...
          <div className="rounded-xl bg-amber-50 border border-amber-200 p-3.5 text-xs text-[#994500] flex items-start gap-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 py-3.5 text-xs sm:text-sm font-bold text-white shadow-md hover:bg-emerald-800 disabled:opacity-50 transition cursor-pointer"
          >
        ...
        <p className="mt-6 text-center text-xs text-slate-700">
          ...
          <Link href="/login" className="font-bold text-[#0B2A4A] underline hover:text-[#071C33]">
            Sign In Here
          </Link>
        </p>
      </div>
