  ...
  if (appliedSuccess) {
    return (
      <div className="mx-auto max-w-xl px-4 py-20 text-center">
        <div className="rounded-3xl border border-teal-200 bg-teal-50/80 p-8 dark:border-teal-900 dark:bg-teal-950/40">
          <CheckCircle2 className="h-12 w-12 text-teal-600 mx-auto mb-3" />
          <h2 className="text-2xl font-black text-teal-900 dark:text-teal-200">
            Consultant Application Submitted!
          </h2>
          <p className="mt-2 text-xs text-teal-700 dark:text-teal-300 leading-relaxed">
